    ...
    <div class="sticky top-0 overflow-hidden w-full rounded-t-2xl mx-auto z-10 bg-gray-100!">
      ...
      >
        <button
          ...
          class="px-1.5 sm:px-3 py-1 text-xs text-gray-900 sm:text-sm border
           border-gray-800 dark:border-neutral-600 rounded-sm whitespace-nowrap
           transition delay-150 duration-100 ease-in-out hover:-translate-y-1 hover:scale-102"
          @click="button.action"
